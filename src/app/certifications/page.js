    ...
    <>
      <nav className="nav" id="nav">
        <div className="nav-inner">
          ...
          <div className={`nav-links${menuOpen ? ' open' : ''}`}><a href="/services" onClick={handleNavClick}>Services</a><a href="/about" onClick={handleNavClick}>About Us</a><a href="/projects" onClick={handleNavClick}>Projects</a><a href="/partners" onClick={handleNavClick}>Partners</a><a href="/certifications" className="active-link" onClick={handleNavClick}>Certifications</a><a href="/contact" onClick={handleNavClick}>Contact</a></div>
          <div className="nav-right"><div className="lang-sw"><a href="/ka/certifications">GE</a><a href="/certifications" className="active">EN</a></div><a href="/contact" className="nav-cta">Get in touch</a></div>
