    ...
    <>
      ...
      <section className="section services" id="services">
        <div className="wrap">
          ...
          <div className="services-grid">
            <div className="srv-card anim anim-d1"><div className="srv-icon"><img src={`data:image/png;base64,${SRV_TOOLS}`} alt="" /></div><h3>Mechanical systems</h3><p>HVAC systems, ventilation, heating and cooling. Climate control engineered for efficiency and comfort.</p></div>
            <div className="srv-card anim anim-d2"><div className="srv-icon"><img src={`data:image/png;base64,${SRV_LIGHTNING}`} alt="" /></div><h3>Electrical systems</h3><p>Power distribution, lighting systems, low-voltage and automation systems for modern buildings.</p></div>
            <div className="srv-card anim anim-d3"><div className="srv-icon"><img src={`data:image/png;base64,${SRV_PIPE}`} alt="" /></div><h3>Plumbing</h3><p>Water supply, drainage and sewerage systems. Designed for reliability and compliance.</p></div>
            <div className="srv-card anim anim-d4"><div className="srv-icon"><img src={`data:image/png;base64,${SRV_FLAME}`} alt="" /></div><h3>Fire protection</h3><p>Fire alarm systems, automatic sprinklers, evacuation systems, fire ventilation and automation.</p></div>
          </div>
        </div>
      </section>
      ...
      <footer><div className="wrap">
        <div className="footer-grid">
          ...
          <div className="footer-col"><h4>Navigation</h4><a href="/services">Services</a><a href="/about">About Us</a><a href="/projects">Projects</a><a href="/contact">Contact</a></div>
