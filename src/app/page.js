        ...
        <div className="hero-inner">
          <div className="hero-left">
            ...
            <p className="hero-sub">
              Integrated mechanical, electrical, plumbing &amp; fire protection solutions
              for developers and construction companies across Georgia.
            </p>
          ...
          <div className="services-grid">
            <div className="srv-card anim anim-d1">
              <div className="srv-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="#000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2v6m0 0L9 5m3 3l3-3"/><rect x="4" y="10" width="16" height="10" rx="2"/><line x1="8" y1="14" x2="8" y2="18"/><line x1="12" y1="14" x2="12" y2="18"/><line x1="16" y1="14" x2="16" y2="18"/></svg>
              </div>
              <h3>Mechanical</h3>
            ...
            <div className="srv-card anim anim-d2">
              <div className="srv-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="#000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="3"/><path d="M12 1v4m0 14v4M4.22 4.22l2.83 2.83m9.9 9.9l2.83 2.83M1 12h4m14 0h4M4.22 19.78l2.83-2.83m9.9-9.9l2.83-2.83"/></svg>
              </div>
              <h3>Electrical</h3>
            ...
            <div className="srv-card anim anim-d3">
              <div className="srv-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="#000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M6 20V10a6 6 0 1112 0v10"/><line x1="4" y1="20" x2="20" y2="20"/><path d="M12 10v6"/></svg>
              </div>
              <h3>Plumbing</h3>
            ...
            <div className="srv-card anim anim-d4">
              <div className="srv-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="#000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2L8 8h3v6H8l4 6 4-6h-3V8h3L12 2z"/></svg>
              </div>
        ...
        <div className="wrap">
          <div className="value-grid">
            ...
            <div className="value-cards">
              <div className="val-card anim anim-d1">
                <h4>Direct cost savings</h4>
                <p>Single contract eliminates coordination overhead. Unified purchasing reduces material costs. Early conflict prevention saves rework budgets.</p>
              </div>
              <div className="val-card anim anim-d2">
                <h4>Operational efficiency</h4>
                <p>Faster project delivery. Accelerated capital turnover. Reduced management resources. We handle regulatory authorities and quality control.</p>
              </div>
