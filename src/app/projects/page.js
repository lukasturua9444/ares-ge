...
export default function ProjectsPage() {
  ...
  const projects = [
    { name: 'Thalasa Group', location: 'Batumi', type: 'Residential complex', tags: ['Fire ventilation', 'Fire alarm', 'Evacuation', 'Sprinkler', 'Automation', 'Electrical', 'Water drainage', 'Sewerage'] },
    { name: 'AIA Plaza', location: 'Batumi', type: 'Residential complex', tags: ['Fire ventilation', 'Fire alarm', 'Evacuation', 'Sprinkler', 'Automation', 'Electrical', 'Water drainage', 'Sewerage'] },
    { name: 'Wondernet Express Investment Group', location: 'Batumi', type: 'Industrial facility', tags: ['Sprinkler diagnostics', 'Fire alarm'] },
    { name: 'Riverside Balakhvani Kutaisi', location: 'Kutaisi', type: 'Residential complex', tags: ['Fire ventilation', 'Fire alarm', 'Evacuation', 'Sprinkler', 'Automation', 'Electrical'] },
    { name: 'M1 Group Kutaisi', location: 'Kutaisi', type: 'Residential & Commercial complex', tags: ['Fire ventilation', 'Fire alarm', 'Evacuation', 'Sprinkler', 'Automation', 'Sound system'] },
    { name: 'Shopping Mall in Kutaisi', location: 'Kutaisi', type: 'Commercial facility', tags: ['Fire ventilation', 'Fire alarm', 'Evacuation', 'Sprinkler', 'Automation', 'Sound system'] },
    { name: 'Casio Development', location: 'Tbilisi', type: 'Residential complex', tags: ['Fire ventilation', 'Fire alarm', 'Evacuation', 'Sprinkler', 'Automation', 'Sound system'] },
    { name: 'Archi Iasamnebi', location: 'Tbilisi', type: 'Residential complex', tags: ['Fire alarm', 'Sprinkler'] },
    { name: 'Compact Mukhiani', location: 'Tbilisi', type: 'Residential complex', tags: ['Fire ventilation', 'Fire alarm', 'Evacuation', 'Sprinkler', 'Automation', 'Electrical'] },
    { name: 'Baustar Rustavi', location: 'Rustavi', type: 'Residential complex', tags: ['Fire ventilation', 'Fire alarm', 'Evacuation', 'Sprinkler', 'Automation', 'Electrical'] },
    { name: 'Kvareli School', location: 'Kvareli', type: 'Public building', tags: ['Fire ventilation', 'Fire alarm', 'Evacuation', 'Sprinkler', 'Automation', 'Electrical'] },
    { name: 'Vashlovani School and Campus', location: 'Vashlovani', type: 'Public building', tags: ['Fire ventilation', 'Fire alarm', 'Evacuation', 'Sprinkler', 'Automation', 'Electrical'] },
  ];
  ...
  return (
    <>
      ...
      <section className="page-header">
        <div className="wrap">
          <div className="section-label anim">Projects</div>
          <h1 className="page-title anim anim-d1">From design to<br /><em>commissioning</em></h1>
      ...
      <section style={{ padding: '0 0 60px' }}>
        <div className="wrap">
          <div className="stats-grid anim" style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <div className="stat-item"><span className="stat-num">6</span><span className="stat-label">Cities in Georgia</span></div>
          </div>
        </div>
      </section>
      ...
      <section className="section">
        <div className="wrap">
          ...
          <h2 className="section-title anim anim-d1">Our portfolio</h2>
      ...
      <section className="section services">
        <div className="wrap" style={{ textAlign: 'center' }}>
          <div className="section-label anim center">Geography</div>
          <h2 className="section-title anim anim-d1" style={{ margin: '0 auto 8px' }}>Active across Georgia</h2>
          <p className="section-sub anim anim-d2" style={{ margin: '0 auto 48px' }}>We deliver projects wherever they are needed.</p>
          <div className="certs-grid anim anim-d3">
            {['Tbilisi', 'Batumi', 'Kutaisi', 'Rustavi', 'Kvareli', 'Vashlovani'].map((city) => (
